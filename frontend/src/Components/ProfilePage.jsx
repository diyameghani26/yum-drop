...
return (
  <div className="min-h-screen bg-gray-100">
    ...
    {/* Header */}
    <div className="bg-orange-500 text-white px-6 md:px-16 lg:px-24 py-8 lg:py-10 flex flex-col md:flex-row justify-between items-start md:items-center">
      <div>
      ...
      <button className="mt-4 md:mt-0 border border-white px-4 lg:px-6 py-2 text-sm lg:text-base rounded hover:bg-white hover:text-[#3d6f85] transition">
        EDIT PROFILE
      </button>
    </div>
...
<div className="hidden md:block w-80 lg:w-96 bg-gray-100 p-6 lg:p-8">
        {menu.map((item) => (
          <div
            key={item}
            onClick={() => setActive(item)}
            className={`px-4 py-3 lg:py-4 cursor-pointer text-sm lg:text-base transition
            ${
              active === item
        ...
        <button
          onClick={logout}
          className="mt-6 w-full py-2 lg:py-3 bg-orange-500 text-white rounded hover:bg-orange-600 text-sm lg:text-base"
        >
          Logout
        </button>
      </div>
     ...
     <div className="flex-1 p-8 lg:p-14 flex items-center justify-center text-center">
        ...
        {active === "Orders" && (
          <div>
            <p className="text-orange-500 text-sm lg:text-base mb-4">
